<section>
    ...
    <div class="mt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        {{-- QR Code --}}
        @if($user->qr_code)
            <div class="relative transform -translate-x-8 translate-y-[2rem]">

                {{-- الكود الذي طلب عدم تغييره يبدأ هنا --}}
                <div class="flex flex-col items-center transform -translate-y-15 translate-x-8">
                    <div id="qr-card-to-download" class="p-4 bg-white rounded-lg shadow-lg">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <p class="mt-2 text-sm font-medium text-blue-600" dir="ltr">{{ '@' . $user->slug }}</p>
                        </div>
                    </div>

                    <div class="flex mt-4 space-x-4 space-x-reverse">
                        <button id="download-button" title="تحميل رمز QR" class="p-2 rounded-full text-blue-500 hover:text-blue-700 hover:bg-blue-50 transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                            </svg>
                        </button>
                        <button id="share-qr-button" title="مشاركة رمز QR" type="button" class="p-2 rounded-full text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                            </svg>
                        </button>
                        <button id="scan-qr-button" title="مسح رمز QR" type="button" class="p-2 rounded-full text-green-500 hover:text-green-700 hover:bg-green-50 transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                {{-- الكود الذي طلب عدم تغييره ينتهي هنا --}}
            </div>
        @endif
